...
public abstract class Hilt_ShopByCategoryFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ShopByCategoryFragment(int layoutID) {
    super(layoutID);
  }
  ...
  protected void inject() {
    ((ShopByCategoryFragment_GeneratedInjector) this.generatedComponent()).injectShopByCategoryFragment(UnsafeCasts.<ShopByCategoryFragment>unsafeCast(this));
  }
