...
public abstract class Hilt_TodoDetailFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_TodoDetailFragment(int layoutID) {
    super(layoutID);
  }
  ...
  protected void inject() {
    ((TodoDetailFragment_GeneratedInjector) this.generatedComponent()).injectTodoDetailFragment(UnsafeCasts.<TodoDetailFragment>unsafeCast(this));
  }
