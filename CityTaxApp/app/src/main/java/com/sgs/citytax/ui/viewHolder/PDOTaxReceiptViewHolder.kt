...
import com.sgs.citytax.databinding.ItemPdoTaxReceiptBinding
import com.sgs.citytax.model.TaxReceiptsDetails
import com.sgs.citytax.util.*
import java.util.*

class PDOTaxReceiptViewHolder(val mBinding: ItemPdoTaxReceiptBinding) : RecyclerView.ViewHolder(mBinding.root) {

    fun bind(receiptDetails: TaxReceiptsResponse, iClickListener: IClickListener?) {

        bindPDO(receiptDetails.taxReceiptsDetails[0],receiptDetails)
    ...
    private fun bindPDO(receiptDetails: TaxReceiptsDetails?, taxReceiptsResponse: TaxReceiptsResponse) {
