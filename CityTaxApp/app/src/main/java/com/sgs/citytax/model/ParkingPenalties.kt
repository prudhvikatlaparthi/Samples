...
data class ParkingPenalties(
    ...
    companion object CREATOR : Parcelable.Creator<ParkingPenalties> {
        override fun createFromParcel(parcel: Parcel): ParkingPenalties {
            return ParkingPenalties(parcel)
        }

        override fun newArray(size: Int): Array<ParkingPenalties?> {
