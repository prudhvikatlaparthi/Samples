...
import com.sgs.citytax.databinding.ActivityLandTaxBinding
...
class LandTaxActivity : BaseActivity(), FragmentCommunicator,
        LocationHelper.Location, LandTaxEntryFragment.Listener,
        ...
        LandTaxSummaryFragment.Listener {
    private lateinit var binding: ActivityLandTaxBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_land_tax)
        showToolbarBackButton(R.string.title_land_txt)
        processIntent()

    }

    private fun attachFragment() {
        val fragment = LandTaxEntryFragment.newInstance()
        val bundle = Bundle()
        ...
        try {
            ...
            mIntent?.let {
                ...
                if (it.hasExtra(Constant.KEY_PROPERTY_DETAILS)) {
                    mPropertyDetailsBySycoTax = it.getParcelableExtra<PropertyDetailsBySycoTax>(Constant.KEY_PROPERTY_DETAILS)
                }
...
//            address = mPropertyDetailsBySycoTax?.address as ArrayList<GeoAddress>
    ...
    override fun onBackPressed() {
        when (currentFragment) {
            ...
            is PropertyHistoryMasterFragment -> {
                (currentFragment as PropertyHistoryMasterFragment).onBackPressed()
                super.onBackPressed()
            }
