...
import com.sgs.citytax.databinding.ItemCmeTaxReceiptBinding
import com.sgs.citytax.model.TaxReceiptsDetails
import com.sgs.citytax.util.*
import java.util.*

class CMETaxReceiptViewHolder(var mBinding: ItemCmeTaxReceiptBinding) : RecyclerView.ViewHolder(mBinding.root) {

    fun bind(taxReceiptsResponse: TaxReceiptsResponse, iClickListener: IClickListener) {

        bindCMETaxReceiptData(taxReceiptsResponse.taxReceiptsDetails[0],taxReceiptsResponse)
    ...
    private fun bindCMETaxReceiptData(
  ...
  //                  mBinding.txtPrintCounts.text = ""//TODO on requirement of Onsite Team, hiding duplicate print counts
            ...
            mBinding.txtQuittanceNo.text = getString(R.string.hyphen)
