...
class DueandAgreementDocumentAdapter(iClickListener: IClickListener, private val fromScreen: Constant.QuickMenu, private val edit: Constant.ScreenMode?) : RecyclerView.Adapter<DueandAgreementDocumentAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return ViewHolder(
                DataBindingUtil.inflate(
                        ...
                        R.layout.due_and_agreement_row_document, parent, false), parent.context)
    }
    ...
    class ViewHolder(var binding: DueAndAgreementRowDocumentBinding, val context: Context) : RecyclerView.ViewHolder(binding.root) {
        fun bind(
