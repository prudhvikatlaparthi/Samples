...
data class VuCRMTaskServiceRequests(
    ...
    companion object CREATOR : Parcelable.Creator<VuCRMTaskServiceRequests> {
        override fun createFromParcel(parcel: Parcel): VuCRMTaskServiceRequests {
            return VuCRMTaskServiceRequests(parcel)
        }

        override fun newArray(size: Int): Array<VuCRMTaskServiceRequests?> {
