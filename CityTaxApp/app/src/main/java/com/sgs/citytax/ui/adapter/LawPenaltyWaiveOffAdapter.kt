...
class LawPenaltyWaiveOffAdapter(private val listener: IClickListener) : BaseExpandableListAdapter() {

    private var groupList: ArrayList<Int> = arrayListOf()
    private var penaltyList: HashMap<Int, ArrayList<LawPenalties>> = hashMapOf()
    ...
    override fun getChildView(groupPosition: Int, childPosition: Int, isLastChild: Boolean, view: View?, parent: ViewGroup?): View {
        ...
        when (getChild(groupPosition, childPosition)) {
            is LawPenalties -> {
                ...
                val childData = getChild(groupPosition, childPosition) as LawPenalties
    ...
    fun set(_groupList: ArrayList<Int>, _penaltyList: HashMap<Int, ArrayList<LawPenalties>>) {
        groupList.clear()
        penaltyList.clear()
