...
class ImpoundDocumentsAdapter (private val mArrayList: ArrayList<COMDocumentReference>, iClickListener: IClickListener) : RecyclerView.Adapter<ImpoundDocumentsAdapter.ViewHolder>() {
