...
class ParkingPenaltyWaiveOffAdapter(private val listener: IClickListener) : BaseExpandableListAdapter() {

    private var groupList: ArrayList<Int> = arrayListOf()
    private var penaltyList: HashMap<Int, ArrayList<ParkingPenalties>> = hashMapOf()
    ...
    override fun getChildView(groupPosition: Int, childPosition: Int, isLastChild: Boolean, view: View?, parent: ViewGroup?): View {
        ...
        when (getChild(groupPosition, childPosition)) {
            is ParkingPenalties -> {
                ...
                val childData = getChild(groupPosition, childPosition) as ParkingPenalties
    ...
    fun set(_groupList: ArrayList<Int>, _penaltyList: HashMap<Int, ArrayList<ParkingPenalties>>) {
        groupList.clear()
        penaltyList.clear()
