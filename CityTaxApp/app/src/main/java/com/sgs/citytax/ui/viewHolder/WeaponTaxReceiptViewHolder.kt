...
import com.sgs.citytax.databinding.ItemWeaponPaymentReceiptBinding
...
class WeaponTaxReceiptViewHolder(val mBinding: ItemWeaponPaymentReceiptBinding) : RecyclerView.ViewHolder(mBinding.root) {
