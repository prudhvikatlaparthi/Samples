...
import com.sgs.citytax.databinding.FragmentPropertySummaryBinding
...
class PropertyTaxSummaryFragment : BaseFragment(), IClickListener {
    private lateinit var mBinding: FragmentPropertySummaryBinding
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        mBinding = DataBindingUtil.inflate(inflater, R.layout.fragment_property_summary, container, false)
        initComponents()
    ...
    private fun setViews() {
        ...
        if (mCode == Constant.QuickMenu.QUICK_MENU_CREATE_PROPERTY ||mCode == Constant.QuickMenu.QUICK_MENU_UPDATE_PROPERTY || mCode == Constant.QuickMenu.QUICK_MENU_BUSINESS_CREATE_PROPERTY|| mCode == Constant.QuickMenu.QUICK_MENU_BUSINESS_UPDATE_PROPERTY) {
    ...
    private fun getPropertyImages() {
        ...
        APICall.getPropertyImages(propertyID
            ...
            override fun onSuccess(response: PropertyImageResponse) {
                ...
                list.add(propertyTax)
                if (list.isNotEmpty())
                    (mBinding.listView.expandableListAdapter as PropertySummaryAdapter).update(getString(R.string.property_images), list, mBinding.listView)
            }
    ...
    private fun getPropertyPlans() {
        ...
        APICall.getPropertyPlans(propertyID
            ...
            override fun onSuccess(response: PropertyPlanImageResponse) {
                ...
                list.add(propertyTax)
                if (list.isNotEmpty())
                    (mBinding.listView.expandableListAdapter as PropertySummaryAdapter).update(getString(R.string.property_plan_documents), list, mBinding.listView)
        ...
        APICall.getPropertyOwners(propertyID, object : ConnectionCallBack<PropertyOwnerResponse> {
            override fun onSuccess(response: PropertyOwnerResponse) {
                ...
                if (response.propertyOwners?.isNotEmpty() == true)
                    (mBinding.listView.expandableListAdapter as PropertySummaryAdapter).update(getString(R.string.property_owner), response.propertyOwners!!, mBinding.listView)
            }
